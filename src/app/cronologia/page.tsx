...
import { ExternalLink, FileText, Gavel, DollarSign, Building2, Zap, AlertTriangle, Megaphone, UserCheck, CheckCircle2 } from 'lucide-react'
...
export default function CronologiaPage() {
  ...
  return (
    <PageShell title="Cronología" subtitle="Historial de acciones de gobierno">
