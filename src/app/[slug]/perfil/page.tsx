...
export default function PerfilPage({ params }: Props) {
  ...
  return (
    <DynamicPageShell slug={params.slug} title="Perfil Oficial" subtitle={nombre}>
      <div className="space-y-4 pb-6">
          ...
          <div className="px-5 pb-5">
            ...
            <div className="mb-5">
              <div className="flex justify-between text-[11px] mb-1.5">
                ...
                <span className="font-bold text-gray-700 dark:text-gray-300">{Math.max(0, monthsInOffice)} / {totalMonths} meses</span>
              </div>
              <ProgressBar value={Math.max(0, monthsInOffice)} max={totalMonths} color="primary" height="sm" />
        ...
        <div className="mx-4 flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-900/10 rounded-xl border border-amber-100 dark:border-amber-800/20">
          ...
          <p className="text-[10px] text-amber-700 dark:text-amber-400 leading-relaxed">
            El puntaje se calcula con base en compromisos públicos oficiales verificados y sus niveles de cumplimiento.
          </p>
        </div>
